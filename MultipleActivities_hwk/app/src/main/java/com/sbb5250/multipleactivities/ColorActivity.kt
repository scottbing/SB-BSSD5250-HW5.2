...
class ColorActivity : AppCompatActivity() {
    ...
    private var hexVal01:String = ""
    private var hexVal02:String = ""
    private var hexVal03:String = ""
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val getIntentDataButton = Button(this).apply {
            ...
            setOnClickListener {
                ...
                val passableData = Intent().apply {
                    putExtra(MainActivity.COLOR_RESULT_01, hexVal01)
                    putExtra(MainActivity.COLOR_RESULT_02, hexVal02)
                    putExtra(MainActivity.COLOR_RESULT_03, hexVal03)
                }
        ...
        val color1 = View(this).apply{
            ...
            setOnClickListener {
                ...
                hexVal01 = hexVal.subSequence(2,hexVal.length).toString()
        ...
        val color2 = View(this).apply{
            ...
            setOnClickListener {
                ...
                hexVal02 = hexVal.subSequence(2,hexVal.length).toString()
        ...
        val color3 = View(this).apply{
            ...
            setOnClickListener {
                ...
                hexVal03 = hexVal.subSequence(2,hexVal.length).toString()
